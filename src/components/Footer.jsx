    ...
    <footer className="premium-footer-new">
      <div className="footer-content-wrap">
        ...
        <div className="footer-left-side">
          <div className="logo-footer-section" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <img 
              src="/whatsbro_avatar.png" 
              alt="WhatsBro logo" 
              style={{ width: '32px', height: '32px', objectFit: 'contain' }} 
            />
            <span style={{ fontWeight: 800, fontSize: '1.05rem', color: '#ffffff' }}>TN sevai</span>
          </div>
          <p style={{ fontSize: '0.7rem', color: '#dcfce7', marginTop: '4px', lineHeight: '1.4', marginBottom: 0 }}>
              Assistant for E-Sevai, PAN card, Voter ID, and other certificate registrations.
          </p>
          <div style={{ marginTop: '6px', display: 'inline-flex', alignItems: 'center', gap: '6px', background: 'rgba(255,255,255,0.1)', padding: '3px 8px', borderRadius: '20px', fontSize: '0.65rem', fontWeight: 'bold', color: '#ffffff' }}>
            <span style={{ display: 'inline-block', width: '5px', height: '5px', borderRadius: '50%', background: '#4ade80' }}></span>
            Customers served: {totalCount}+
          </div>
        </div>

        {/* Right Side: WhatsApp Chat Badge */}
        <div className="footer-right-side">
          <div className="footer-contact-details">
            <h4 style={{ fontSize: '0.8rem', color: 'white', marginBottom: '4px', fontWeight: 'bold' }}>TN sevai Help Desk</h4>
            <a 
          ...
          <div className="circular-contact-badge" style={{ width: '44px', height: '44px', border: 'none', boxShadow: 'none', background: 'transparent', borderRadius: '0', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'visible' }}>
